...
public class Hello {
	...
	public void init() {
		...
		driver.get("D:\\Users\\ADM-IG-HWDLAB1F\\Downloads\\selenium-casestudy1-master\\Testing6CASE1\\Index.html");
	...
	public void state_is(String arg1) throws Throwable 
	{
		...
		if(jsAlert.getText().equals("validated"))
		{
			Thread.sleep(1000);
			jsAlert.accept();
			driver.navigate().to("D:\\Users\\ADM-IG-HWDLAB1F\\Downloads\\selenium-casestudy1-master\\Testing6CASE1\\nextPage.html");
